...
public class MioloRelatorioCliente extends JPanel {
	...
	public MioloRelatorioCliente() {
		...
		gbl_panel_salvar.columnWeights = new double[] { 1.0, 1.0, 0.0,
				Double.MIN_VALUE };
	...
	public Runnable getAcaoGerarRelatorio() throws SQLException {
		return () -> {
			...
			gr.gerarRelatorio(sql, "/RelatorioClientes.jasper", caminho);
		};
	}
	...
	private String gerarClienteCidade() {
		...
		if (txtcidade.getText().isEmpty()) {
			...
			sql = "where cidade like \"%" + txtcidade.getText() + "%\" ";
		}
		return sql;
	}
}
