...
public class MioloCadCliente extends JPanel {
	...
	public MioloCadCliente() {
		...
		gridBagLayout.columnWidths = new int[]{463, 0};
		gridBagLayout.rowHeights = new int[]{44, 176, 79, 0, 0};
		...
		setLayout(gridBagLayout);
				...
				panel_dados.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Dados Pessoais", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
				...
				add(panel_dados, gbc_panel_dados);
						...
						gbl_panel_dados.columnWeights = new double[]{1.0, 1.0, 1.0, Double.MIN_VALUE};
				...
				panel_contato.setBorder(new TitledBorder(null, "Contato", TitledBorder.LEADING, TitledBorder.TOP, null, null));
				GridBagConstraints gbc_panel_contato = new GridBagConstraints();
				gbc_panel_contato.fill = GridBagConstraints.BOTH;
				...
				add(panel_contato, gbc_panel_contato);
						...
						gbl_panel_contato.columnWeights = new double[]{1.0, 1.0, Double.MIN_VALUE};
						gbl_panel_contato.rowWeights = new double[]{0.0, 0.0, Double.MIN_VALUE};
				...
				panel_tabela.setBorder(new TitledBorder(null, "Clientes Cadastrados", TitledBorder.LEADING, TitledBorder.TOP, null, null));
