...
public class MioloCadCliente extends JPanel {
	...
	public MioloCadCliente() {
																		...
																		gridBagLayout.rowHeights = new int[]{30, 46, 150, 62, 190, 0};
																		...
																		setLayout(gridBagLayout);
																						...
																						panel_codigo.setLayout(gbl_panel_codigo);
																								...
																								panel_codigo.add(lblId, gbc_lblId);
																										...
																										button.setIcon(new ImageIcon(MioloCadCliente.class.getResource("/br/univel/icones/add.png")));
